...
export const metadata: Metadata = {
  title: "Personal Library - Full Width Editorial Book Curation",
  description: "A full-width curated digital library showcasing top books with rich color-block editorial frames and interactive PDF reading.",
};
