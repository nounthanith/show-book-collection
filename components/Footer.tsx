...
export default function Footer() {
  return (
    <aside className="shrink-0 flex flex-row md:flex-col md:justify-center items-center md:items-start justify-between md:justify-start px-4 sm:px-6 lg:px-8 py-3 md:py-0 border-t md:border-t-0 md:border-l border-stone-300/60 md:w-48 lg:w-72">
      ...
      <div className="hidden md:block mt-8 text-xs text-stone-500 font-medium leading-relaxed space-y-2">
        ...
        <p>&copy; {new Date().getFullYear()} JZA Personal Library. All rights reserved.</p>
      </div>
    </aside>
  );
}
